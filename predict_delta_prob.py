...
def parse_args():
    ...
    ap.add_argument("--mutation1", required=True, help="突变前 bed/tsv（含 chr start end regionID）")
    ap.add_argument("--mutation2", required=True, help="突变后 bed/tsv（含 chr start end regionID）")
    ap.add_argument("--sequence_signature1", required=True, help="突变前特征 .npy（与 pre_meta 对应）")
    ap.add_argument("--sequence_signature2", required=True, help="突变后特征 .npy（与 post_meta 对应）")
